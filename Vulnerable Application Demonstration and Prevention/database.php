...
<body>
  ...
  <div class="button" align="center" style="background-color:#757575;padding:10px;">
    <button class="btn btn-primary" type="button" name="homepagebutton" onclick="location.href='homepage.html'">Home Page</button>
  </div>
  </link>
  <div align="center" style="background-color:#c9c9c9;padding:150px;">
    ...
    <form method="POST">
      ...
      <input class="btn btn-primary" type="submit" name="submit" value="Enter" style="padding:8px;font-family:'Georgia'"></form>

    <form method="POST">
      <label style="font-size:24px;font-family:'Georgia'">Restore Database:</label>
      <input class="btn btn-primary" type="submit" name="submit1" value="Enter" style="padding:8px;font-family:'Georgia'"></form>
  </div>

<div align="center" style="background-color:#afafaf;padding:60px;">
<?php
